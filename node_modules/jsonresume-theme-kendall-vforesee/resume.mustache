    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-7">
          ...
          <!-- VOLUNTEER -->
          <div class="box">
            <h2><i class= "fas fa-users ico"></i>Projects</h2>
            {{#projects}}
              <div class="job clearfix">
                <div class="row">
                  <div class="details">
                ...
                <div class="row">
                  <div class="job-details col-xs-11">
                    ...
                    <div class="description">
                      ...
                      <div class="highlights">Roles</div>
                      <ul class="list-group">
                        {{#roles}}
                        <li class="list-group-item">{{{.}}}</li>
                        {{/roles}}
        ...
        <div class="col-xs-12 col-sm-5">
          ...
          <div class="box clearfix">
            ...
            <div class="contact-item">
              ...
              <div class="title {{^basics.location.address}}only {{/basics.location.address}} pull-right">{{basics.location.city}}{{#basics.location.region}}, {{basics.location.region}}{{/basics.location.region}}{{#basics.location.postalCode}} {{basics.location.postalCode}}{{/basics.location.postalCode}}{{#basics.location.country}} {{basics.location.country}}{{/basics.location.country}}</div>
            </div>
            {{/basics.location}}
            {{#basics.phone}}
            <div class="contact-item">
